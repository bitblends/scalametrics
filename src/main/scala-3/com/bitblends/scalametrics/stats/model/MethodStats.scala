...
case class MethodStats(
  ...
  /**
    * Converts the product elements of the class into a map where each key is the name of the product element and the
    * corresponding value is its string representation. Handles specific cases for `Option`, `Seq`, and `None` values.
    *
    * @return
    *   A map with the names of the product elements as keys and their string representations as values.
    */
