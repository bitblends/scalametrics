...
case class FileRollup(
  ...
  /**
    * Converts the properties of this instance into a map where the keys represent the property names and the values
    * represent their corresponding string representations. Handles special value types such as options, sequences, and
    * other objects by transforming them appropriately into strings.
    *
    * @return
    *   A map containing property names as keys and their corresponding stringified values.
    */
