...
case class MethodStats(
  ...
  /**
    * Converts the fields of the MethodStats object into a Map where the keys are field names as strings, and the values
    * are the corresponding field values in string representation.
    *
    * @return
    *   a Map[String, String] representing the fields of the MethodStats object and their values.
    */
